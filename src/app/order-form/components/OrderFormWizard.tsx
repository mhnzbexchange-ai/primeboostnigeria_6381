 ...
 * ============================================================
 *
 * Replace the account number below with your real Kuda
 * business account number before enabling bank transfer.
 */
...
/*
 * ============================================================
 * PRIMEBOOST NIGERIA - DISCOUNT CODE
 * ============================================================
 *
 * PRIME10 = 10% OFF
 */
...
export default function OrderFormWizard() {
  ...
  const discountAmount = discountApplied
    ? Math.round(
        originalTotalPrice * (DISCOUNT_PERCENTAGE / 100)
      )
    : 0;
  ...
  const applyDiscountCode = () => {
    ...
    if (code === DISCOUNT_CODE) {
      if (originalTotalPrice <= 0) {
        toast.error(
          'Please select a service and quantity first.'
        );
        return;
      }
  ...
  const copyToClipboard = (
    ...
    if (!navigator.clipboard) {
      toast.error(
        'Copy is not available on this device.'
      );
      return;
    }
  ...
  const createOrder = async (
    ...
    if (!user?.id || !selectedService) {
      throw new Error(
        'Please sign in and select a service.'
      );
    }
  ...
  const submitBankTransferOrder = async (
    ...
    if (
      ...
      BUSINESS_BANK_DETAILS.accountNumber ===
        'ENTER_YOUR_KUDA_ACCOUNT_NUMBER_HERE'
    ) {
      toast.error(
        'Bank transfer account details are not configured yet.'
      );
      return;
    }
    ...
    try {
      ...
      /*
       * Private bucket:
       * Store the storage path rather than a public URL.
       */
      const proofUrl = '';
  ...
  const handleNext = () => {
    ...
    if (
      ...
      toast.error(
        'Please enter your profile or post URL.'
      );
      return;
    }
          ...
          {isBankTransfer && (
            <div className="mb-4 flex items-start gap-2 text-left p-3 rounded-xl bg-yellow-400/10 border border-yellow-400/30">
              ...
              <p className="text-xs text-yellow-200/90 leading-relaxed">
                Bank transfers are manually
                reviewed. Verification time can
                vary depending on payment
                confirmation and business hours.
              </p>
            </div>
          )}
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Delivery estimates are service
                estimates and may vary. Results can
                also vary by platform and service.
                You can monitor your order from your
                dashboard.
              </p>
            </div>
          </div>
    ...
    <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Choose a service, review the price and
              submit your order.
            </p>
          </div>
          ...
          <div className="space-y-5 animate-fade-in-up">
            <div className="card-base card-gradient-bg">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                Select the platform associated
                with the service you want to
                order.
              </p>
            ...
            <div className="rounded-xl border border-blue-400/20 bg-blue-400/5 p-4">
              <div className="flex items-start gap-2">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  ...
                  minimum quantities and estimated
                  delivery information are shown
          ...
          <div className="space-y-5 animate-fade-in-up">
            ...
            <div className="card-base card-gradient-bg">
              ...
              <p className="text-xs text-muted-foreground mb-4 leading-relaxed">
                Enter the public URL where the selected
                service should be applied. PrimeBoost
                does not require your social media
                password for a standard order.
              </p>
              ...
              <div className="mt-3 flex items-start gap-2 p-3 rounded-lg bg-blue-400/5 border border-blue-400/20">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  ...
                  and accessible. Private accounts
                  or restricted content may affect
            ...
            <div className="space-y-5 animate-fade-in-up">
              ...
              <div className="rounded-xl border border-primary/15 bg-primary/5 p-4">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Enter your discount code during
                    the payment step to receive an
                    eligible discount.
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      ...
                      service, URL, quantity and total amount
                      are correct. Service results and delivery
                      times may vary depending on the service
                      and platform.
                    </p>
                  </div>
                </div>
      ...
      <div className="mt-8 text-center">
        <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground">
          ...
          <span>
            Review all service information before
            payment.
          </span>
        </div>
