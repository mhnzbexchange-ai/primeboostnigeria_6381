...
export const metadata: Metadata = {
  ...
  description: 'Buy real followers, likes, views, and engagement for TikTok, Instagram, Telegram, Snapchat, and X. Fast delivery, Naira payments, trusted by thousands of Nigerians.',
  icons: {
    icon: [
