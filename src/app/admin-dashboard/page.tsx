      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">PrimeBoost Nigeria — Platform Overview · August 2026</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <span className="badge-base status-failed">Admin Access</span>
          </div>
        </div>
